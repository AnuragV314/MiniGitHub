...
const ProfileInfo = ({ userProfile }) => {
	...
	return (
		<div className='lg:w-1/3 w-full flex flex-col gap-2 lg:sticky md:top-10'>
			<div className='backdrop-blur-sm rounded-lg p-4 border-s border-gray-500 hover:bg-gray-600/10'>
				<div className='flex gap-3 items-center'>
					...
					<div className='flex gap-2 items-center flex-col'>
						...
						<a
							...
							target='_blank'
							rel='noreferrer'
							className='backdrop-blur-sm font-medium w-full text-xs p-2 rounded-md cursor-pointer border-s flex items-center gap-2 border-gray-500 hover:bg-gray-600/10'
						>
							<FaEye size={16} />
							View on Github
						</a>
			...
			<div className='flex flex-wrap gap-2 mx-4'>
				{/* Followers Count */}
				<div className='flex items-center gap-2 backdrop-blur-sm rounded-lg p-2 flex-1 min-w-24 border-s border-gray-500 hover:bg-gray-600/10'>
