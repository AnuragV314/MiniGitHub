...
function Search({onSearch}) {
  ...
  return (
    <form
      className="max-w-xl mx-auto p-2 my-3"
    ...
    >
      ...
      <div className="relative border-s rounded-lg border-gray-500">
        ...
        <input
          type="search"
          id="default-search"
          className="block w-full p-4 ps-10 text-sm rounded-lg backdrop-blur-sm focus:ring-blue-500 focus:border-blue-500 bg-transparent focus:bg-transparent "
          placeholder="e.g. anuragV314"
          required
		  value={username}
