...
function ExplorePage() {
  ...
  return (
    <div className="px-4 ">
      <div className="backdrop-blur-md max-w-2xl mx-auto rounded-md p-4 border-s border-gray-500  hover:bg-gray-600/10">
        ...
        {repos.length > 0 && (
          <h2 className="text-lg font-semibold text-center my-7">
