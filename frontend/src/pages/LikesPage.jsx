...
function LikesPage() {
  ...
  return (
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
      <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 backdrop-blur-sm">
        ...
        <tbody>
          {likes.map((user, idx) => (
            <tr
              key={user.username}
              className="bg-glass border-b hover:bg-gray-600/10"
            >
